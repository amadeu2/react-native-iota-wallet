...
class WalletMobile: NSObject {
  ...
  // Handles the Swift / C pointers with a context object using Unmanaged types
    ...
    @objc func messageHandlerNew(
      storagePath: NSString,
      clientOptions: NSDictionary,
      coinType: NSNumber,
      secretManager: NSDictionary,
    ...
    //     guard let _message = message?.replacingOccurrences(of: "\\", with: "") else {
